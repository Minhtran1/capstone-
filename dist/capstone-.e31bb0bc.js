...
function addNavEventListeners() {
  console.log("pizza");
  document.getElementsByClassName("menu-items").forEach(function (navLink) {
...
function addPicOnFormSubmit(st) {
  if (st.view === "More") {
    document.querySelector("More").addEventListener("submit", function (event) {
      event.preventDefault();
      var inputList = Array.from(event.target.elements);
      inputList.pop();
